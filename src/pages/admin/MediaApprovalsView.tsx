      ...
      <Card>
        <div className="p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            The media approvals system is being migrated to the new database infrastructure.
            This feature will be available soon.
          </p>
          <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
            <p className="text-blue-700 text-sm">
              Media asset management and approval workflows are being redesigned.
              Media files can still be uploaded through the main interface temporarily.
            </p>
          </div>
        </div>
      </Card>
